...
class SimCardView:
    ...
    def __init__(self):
        ...
        person_table = Table(self.win,["id","name", "family", "nid", "date_birth", "father_name", "email", "address"],
        ...
        sim_card_table = Table(self.win,["id","number","operator","status","sim_type","charge"],
                               [20,60,50,50,60,60],
                               380,20,
                               self.sim_card_table_click)

        payment_table = Table(self.win,["id","date_time", "amount", "description"],
                              [20,60,50,70],
                              700,20,
